...
% Continuous transition between Slater and Mott insulators in SU(6) Hubbard model on square lattice
% Slater and Mott insulators in the SU(6) Hubbard model
% Near the QCP, AF decreases but single particle gap increases, indicating a Mott physics because in Slater AF, the
% single particle gap should be proportional to AF moment. 
% However, is there a phase transition from Slater-AF to Mott-AF or just a crossover? Any way to distinguish them?
% continuous transition and critical exponents
% discussion about deconfined QCP
